...
/**
 * Created by Android1 on 7/6/2017.
 */
...
public class WeatherInfo {
    ...
    private static final String OPEN_WEATHER_MAP_API = "78dfe9e10dd180fadd805075dd1a10d6";
    ...
    public static class placeIdTask extends AsyncTask<String, Void, JSONObject> {
        ...
        public placeIdTask(AsyncResponse asyncResponse) {
            Log.d("Weather","Weather" + asyncResponse.toString());
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                Log.d("jsonWeather", "JSON results" + jsonWeather);
            } catch (Exception e) {
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if (json != null) {
                    ...
                    Log.d("Weather", " " + city + " " + description + " " + temperature + " " + humidity);
                ...
                Log.e("Weather", "Cannot process JSON results", e);
            }
    ...
    public static JSONObject getWeatherJSON(String lat, String lon) {
        try {
            ...
            Log.d("Weather Exception ",e.getMessage()+" ");
            return null;
        }
    }
